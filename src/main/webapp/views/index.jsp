...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .user-greeting {
            color: var(--text2); font-size: 0.88rem; padding: 6px 12px;
        }
        .nav-btn-login {
        ...
        .nav-btn-login:hover { background: #c40812; transform: translateY(-1px); box-shadow: 0 4px 15px rgba(229,9,20,0.4); }
        .nav-btn-logout {
    ...
    function filterMovies(q) {
        ...
        if (visible === 0 && q) {
            if (!emptyMsg) {
                ...
                emptyMsg.innerHTML = '<i class="fas fa-search"></i><p>Không tìm thấy phim nào cho "<strong>' + q + '</strong>"</p>';
